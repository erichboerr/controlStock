...
public class NuevoInsumosImpresora extends JDialog implements ActionListener {
	...
	public NuevoInsumosImpresora() {
		...
		btnAceptar.setIcon(new ImageIcon(NuevoInsumosImpresora.class.getResource("/com/controlStock/controlStock/icons/aceptar-48px.png")));
		...
		btnAceptar.setBounds(335, 147, 48, 48);
		getContentPane().add(btnAceptar);

		btnCancelar = new JButton("");
		btnCancelar.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnCancelar.setIcon(new ImageIcon(NuevoInsumosImpresora.class.getResource("/com/controlStock/controlStock/icons/cerrar-ventana-48px.png")));
