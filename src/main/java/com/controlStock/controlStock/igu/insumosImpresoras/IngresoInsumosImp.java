...
public class IngresoInsumosImp extends JDialog implements ActionListener {
	...
	public IngresoInsumosImp() {
		...
		btnAceptar.setIcon(new ImageIcon(IngresoInsumosImp.class.getResource("/com/controlStock/controlStock/icons/aceptar-48px.png")));
		...
		btnCancelar.setIcon(new ImageIcon(IngresoInsumosImp.class.getResource("/com/controlStock/controlStock/icons/cerrar-ventana-48px.png")));
